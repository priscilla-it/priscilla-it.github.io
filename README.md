...
- Пожалуйста, учитывайте, что в процессе модификации на корпусе могут появиться небольшие повреждения.

- В некоторых случаях мы не сможем выполнить ваши пожелания.

- Мы занимаемся только простыми ремонтными работам, например: замена переключателя.

- Оплата осуществляется по готовности работы, перед отправкой.

- Доставка осуществляется силами клиента, доставка обратно включена в стоимость.
